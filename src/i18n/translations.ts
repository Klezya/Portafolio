...
export const translations = {
  es: {
    ...
    "about.p1":
      "Soy un desarrollador backend que no se queda quieto. Me nutro de documentación oficial, cursos y, sobre todo, de construir proyectos propios donde puedo experimentar.",
    "about.p2":
      'Mi foco principal está en APIs y sistemas backend con Python, Docker y AWS — aprendiendo cada vez mas sobre tecnologías relacionadas como: <strong style="color: var(--color-text); font-weight: 600;">DevOps</strong>, <strong style="color: var(--color-text); font-weight: 600;">optimización de bases de datos</strong> y <strong style="color: var(--color-text); font-weight: 600;">ciberseguridad</strong>. No para ser experto en todo, sino para tomar mejores decisiones en lo que construyo.',
    "about.area.devops": "DevOps",
    "about.area.devops.desc":
      "CI/CD, infraestructura como código, automatización de despliegues.",
    "about.area.databases": "Bases de datos",
    "about.area.databases.desc":
      "Indexación, query optimization, modelos relacionales y NoSQL.",
    "about.area.security": "Ciberseguridad",
    "about.area.security.desc":
      "Seguridad en APIs, OWASP, hardening y buenas prácticas.",
    "about.area.networking": "Redes",
    "about.area.networking.desc":
      "Protocolos, arquitecturas distribuidas y comunicación entre servicios.",
    ...
    "edurun.feature1":
      "Trazabilidad completa: teclas, tiempo y cambios en tiempo real",
    "edurun.feature2": "Ejecución aislada en contenedores Docker",
    "edurun.feature3": "Comunicacion segura con Canvas LMS usando LTI 1.3",
    ...
    "securevault.feature1":
      "Encriptacion y manejo seguro de datos con arquitectura Zero-Knowledge",
    "securevault.feature2": "Entorno Dockerizado con Docker Compose",
    "securevault.feature3":
      "Frontend Angular 21 con arquitectura standalone y lazy-loading",
    ...
    "cert.awscq.name": "AWS Cloud Quest: Cloud Practitioner",
    "cert.awscq.date": "Marzo 2026",
    ...
    "contact.form.error":
      "Hubo un error al enviar. Esríbeme directo a benjamin.nunez.beat@gmail.com",

    // Footer
    "footer.tagline":
      "Backend developer construyendo APIs robustas con Python, Docker y AWS.",
  ...
  en: {
    ...
    "about.p1":
      "I'm a backend developer who never stands still. I feed on official documentation, courses and, above all, building my own projects where I can experiment.",
    "about.p2":
      'My main focus is on APIs and backend systems with Python, Docker and AWS — learning more and more about related technologies such as: <strong style="color: var(--color-text); font-weight: 600;">DevOps</strong>, <strong style="color: var(--color-text); font-weight: 600;">database optimization</strong> and <strong style="color: var(--color-text); font-weight: 600;">cybersecurity</strong>. Not to be an expert in everything, but to make better decisions in what I build.',
    "about.area.devops": "DevOps",
    "about.area.devops.desc":
      "CI/CD, infrastructure as code, deployment automation.",
    "about.area.databases": "Databases",
    "about.area.databases.desc":
      "Indexing, query optimization, relational and NoSQL models.",
    "about.area.security": "Cybersecurity",
    "about.area.security.desc":
      "API security, OWASP, hardening and best practices.",
    "about.area.networking": "Networking",
    "about.area.networking.desc":
      "Protocols, distributed architectures and service communication.",
    ...
    "edurun.feature1":
      "Full traceability: keystrokes, time and real-time changes",
    "edurun.feature2": "Isolated execution in Docker containers",
    "edurun.feature3": "Secure communication with Canvas LMS using LTI 1.3",
    ...
    "securevault.feature1":
      "Encryption and secure data handling with a Zero-Knowledge architecture",
    "securevault.feature2": "Dockerized environment with Docker Compose",
    "securevault.feature3":
      "Angular 21 frontend with standalone architecture and lazy-loading",
    ...
    "contact.form.error":
      "There was an error sending. Write to me at benjamin.nunez.beat@gmail.com",

    // Footer
    "footer.tagline":
      "Backend developer building robust APIs with Python, Docker and AWS.",
